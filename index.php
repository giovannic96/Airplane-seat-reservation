    ...
    <div id="content-wrapper" class="w3-content w3-margin-top" style="max-width:1400px;">
      <div class="w3-row-padding">
        <aside class="w3-quarter">
          ...
          </div><br><span id="myspan"></span> <!-- Here there will be the stats-container -->
        </aside>
            ...
            <?php
              ...
              for ($i=0; $i<CABIN_HEIGHT; $i++) { ?>
                 ...
                 for ($j=0; $j<CABIN_WIDTH; $j++) { ?>
                   <li class="seat">
                    <input id=<?php echo ($i+1).$alphabet[$j]; ?> type="checkbox" class="home-btns" onclick="alert('Per prenotare i posti bisogna effettuare il login.')"/>
                    <label class="<?php 
                      if($reservations) { 
      ...
      <!-- This will be moved to the correct place (left column of the page) by using JQuery -->

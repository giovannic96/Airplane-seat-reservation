      ...
      <div class="w3-row-padding">
        ...
        <div class="w3-threequarter">
          <div class="w3-container w3-card w3-white w3-margin-bottom w3-round-large">
            <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user fa-fw w3-margin-right w3-xxlarge main-color"></i>Login</h2>
            <form name="login-form" class="login-form" action="validation.php" method="post">
                <div class="w3-container">
                    ...
                    <input class="input-form w3-margin-top w3-round-xxlarge w3-light-grey" type="password" name="password" placeholder="Password" pattern="(?=.*[a-z])(?=.*[A-Z\d]).+" title="La password deve contenere almeno un carattere alfabetico minuscolo, ed almeno un altro carattere che sia alfabetico maiuscolo oppure un carattere numerico" required>
                    <?php 
                    ...
                    <?php 
                     if(isset($_GET['msg'])) {
                        if(!empty($_GET['msg'])) { ?>
                          <div class="w3-padding error-back-color w3-round-xxlarge w3-text-red"><span><b><?php echo 'Sessione scaduta. Provare ad effettuare nuovamente il login.';?></b></span></div></b></span></div>
                        <?php }
                        $_GET['msg'] = "";} ?>
                    <button class="my-input-btn my-margin-top main-color w3-margin-bottom w3-round-xxlarge" type="submit">Accedi</button>
                </div>
            </form>
          </div>
        </div> 
